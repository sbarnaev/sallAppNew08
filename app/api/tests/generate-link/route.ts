...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Используем NEXT_PUBLIC_APP_URL если доступен, иначе определяем из запроса
    ...
    if (appBaseUrl) {
      ...
      // Fallback: определяем из запроса
