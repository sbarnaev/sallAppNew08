    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          ...
          <Link href={`/forecast/${params.id}`} className="rounded-xl bg-purple-600 text-white px-4 md:px-6 py-2 hover:bg-purple-700 flex items-center gap-2">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link href={`/profiles/new?clientId=${params.id}`} className="rounded-xl bg-brand-600 text-white px-4 md:px-6 py-2 hover:bg-brand-700 flex items-center gap-2">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
