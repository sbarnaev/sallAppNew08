...
/**
 * Middleware для защищённых роутов - проверяет токен И доступ по подписке
 * Если нет доступа - редиректит на страницу с информацией о подписке
 */
export async function requireAuthAndSubscription(): Promise<string> {
